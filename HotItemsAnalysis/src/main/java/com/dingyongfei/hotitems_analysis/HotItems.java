package com.dingyongfei.hotitems_analysis;

import com.dingyongfei.hotitems_analysis.beans.ItemViewCount;
import com.dingyongfei.hotitems_analysis.beans.UserBehavior;
...
public class HotItems {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取数据，创建DataStream
        // DataStream<String> inputStream = env.readTextFile("D:\\Projects\\BigData\\userbehavioranalyse\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv");
    ...
    public static class TopNHotItems extends KeyedProcessFunction<Tuple, ItemViewCount, String> {
        ...
        @Override
        public void processElement(ItemViewCount value, KeyedProcessFunction<Tuple, ItemViewCount, String>.Context ctx, Collector<String> collector) throws Exception {
